...
<p>
    <h4>General</h4>
    <ul>
        <li>100 Wood ≈ 1 Rarity</li>
        <li>You can enhance unequipped Curiosities in your inventory, and will only receive the rarity and power when you equip them to a minister.</li>
    </ul>
</p>
...
<p>
    ...
    <table class="table">
        <thead>
        <tr>
            <th scope="col">Heirloom Item</th>
            <th scope="col">Base Quality</th>
            <th scope="col">Potential</th>
            <th scope="col">Stats</th>
            <th scope="col">Stat Bonus</th>
        </tr>
